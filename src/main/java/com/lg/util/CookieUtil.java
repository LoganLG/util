...
import com.lg.util.constant.EnvirConstant;
...
public class CookieUtil {
     ...
     * cookie最大默认设置为1年
     */
    private static final int COOKIE_DEFAULT_MAX_AGE = (int) TimeUnit.DAYS.toSeconds(365);
    ...
    public static void addCookie(String name, String value, HttpServletResponse response) {
        addCookie(name, value, EnvirConstant.DOMAIN, COOKIE_DEFAULT_MAX_AGE, "/", response);
    }
    ...
    public static void removeCookie(String name, HttpServletRequest request, HttpServletResponse response) {
        CookieUtil.removeCookie(name, EnvirConstant.DOMAIN, request, response);
    }
}
